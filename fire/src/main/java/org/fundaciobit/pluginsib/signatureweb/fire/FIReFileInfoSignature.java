...
public class FIReFileInfoSignature {
     ...
     */
    public FIReFileInfoSignature(SignatureFormat signType, SignatureAlgorithm signAlgorithm, Properties signProperties,
    ...
    public FIReFileInfoSignature(SignatureOperation signOperation, SignatureFormat signType,
            SignatureAlgorithm signAlgorithm, Properties signProperties, X509Certificate certificate, byte[] dataToSign,
